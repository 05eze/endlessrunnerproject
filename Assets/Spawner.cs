...
public class Spawner : MonoBehaviour
{
    ...
    float timeSinceLastSpawn = 0.0f;    //Tracks the time since we last spawnned something objects 

    public float minSpawnTime = 0.5f; //Minimum amount of time between spawning objects
    public float maxSpawnTime = 3.0f; //MAximum amount of time betweem spawning objects 
    ...
    void Update()
    {
        ...
        //This eill create a float that counts up in seconds
